...
const CaffeineModel = forwardRef(({ position, ...props }, ref) => {
  ...
  return (
    <>
      <group {...props} dispose={null} position={position} rotation={[0.4, -0.4, 0]} ref={ref} scale={1}>
...
CaffeineModel.displayName = 'CaffeineModel'
export default CaffeineModel
