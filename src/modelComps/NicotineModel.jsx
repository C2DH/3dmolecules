...
const NicotineModel = forwardRef(({ position, ...props }, ref) => {
  ...
  const sticks1Points = createPointsGeometry(nodes.sticks_1.geometry, atomsColors[3])
  ...
  return (
    <>
      <group
        ...
        dispose={null}
        position={position}
        rotation={isBigScreen ? [1.8, 0.3, -0.3] : [0, -0.6, 1.57]}
        ref={ref}
        scale={1}
      >
...
NicotineModel.displayName = 'NicotineModel'
export default NicotineModel
